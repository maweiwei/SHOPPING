    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="{{url('/Home/user')}}">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                  
	         <span>管理员：</span>
                 <font color="black">
	         <input type="text" name="keyword" value="" class="text-word">
	         <input name="" type="submit" value="查询" class="text-but" style="background:gray;color:#FFF"></font>
	         </form>
         </td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><img src="{{$tmp->avartar}}" width="50" height="50"></td>
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="/Home/user/edit/{{$tmp->uid}}" target="" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="/Home/user/delete/{{$tmp->uid}}" target="" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
 @endforeach
    </table></td>
    </tr>
  <tr>
 <td align="right" valign="top" class="fenye">{!!$user->appends(["keyword"=>$key])->render()!!}</td></a></td>
  </tr>
</table>
</body>
</html>