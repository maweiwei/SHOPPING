			...
			<div class="cont">
				...
				<div class="cont-main" >
					<div class="main-wrap mt15">
                                            <form action="/Home/adress" method="post">
						...
						<div class="user-profile clearfix" style="margin-left: 0px;width: 100%;border: 0px;">
							...
							<div style="margin-left: 150px;margin-top:-40px;">
								<textarea style="width:500px;height: 90px;padding: 5px;" name="city3" value="" placeholder="建议您如实填写详细收货地址，例如街道 名称，门牌号码，楼层和房间号等信息"></textarea>
							</div>
							
							<div style="margin-left: 80px;margin-top: 20px;">
								<span class="titles">邮政编号:</span>
								<input type="text" name="postcode" value="" placeholder="如您不清楚地区邮递号，请填写000000" style="padding: 5px;width: 300px;margin-left: 14px;" />
							</div>
							
							<div style="margin-left: 55px;margin-top: 30px;">
								<span style="color: #F2873B;">*</span>
								<span class="titles">收货人姓名:</span>
								<input type="text" name="uname" value=" " placeholder="长度不超过25个字符" style="padding: 5px;width: 300px;margin-left: 14px;" />
							</div>
							<div style="margin-left: 80px;margin-top: 30px;">
								...
								<input type="text"  name="phone" value="" placeholder="手机号码必须填写"  style="padding: 5px;width: 200px;"/>
							</div>
								...
								<table class="sui-table table-bordered-simple" style="margin-top: 20px;">
								  ...
								  <tbody>
								    <tr>
								      ...
								      <td>{{$tmp->adress or ""}}</td>
								      <td>{{$tmp->postcode or ""}}</td>
								      <td>{{$tmp->phone or  ""}}</td>
								      <td style="color: #007AFF;">
                                                                      <a href="/Home/adress/update/{{$tmp->id or ""}}">修改</a>&nbsp;|&nbsp;<a href="/Home/adress/destroy/{{$tmp->id or ""}}">删除</a></td>
