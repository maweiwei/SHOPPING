...
<body>
    ...
    <div class="g-bd">
        <div class="g-row">
                        ...
                        <span class="u-icon icon-cart-tips icon-cart-empty"><img src="{{ asset("/images/home/car/sendcar.png") }} " style="width:111px;height:149px"></span>
                        <div class="cart-tips-cnt">
                            <div class="cart-tips-text">
                                <p>订单提交成功，<br>快去抢购其他的商品吧！</p>
                            </div>
                            <div class="cart-tips-actions">
                                <a class="ui-btn-primary ui-btn-medium" href="{{ url("/") }}" role="button">在逛逛</a><a class="ui-btn-default  ui-btn-medium" href="{{ url("/Home/indent") }}" role="button">查看订单</a>
                            </div>
                        </div>
                    </div>
