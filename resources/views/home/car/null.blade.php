...
<body>
    ...
    <div class="g-bd">
        <div class="g-row">
                        ...
                        <span class="u-icon icon-cart-tips icon-cart-empty"><img src="{{ asset("/images/home/car/nullcar.png") }}"></span>
                        <div class="cart-tips-cnt">
                            <div class="cart-tips-text">
                                <p>购物袋空空如也，<br>快去抢购心仪的商品吧！</p>
                            </div>
                            <div class="cart-tips-actions">
                                <a class="ui-btn-primary ui-btn-medium" href="{{ url("/") }}" role="button">立即抢购</a><a class="ui-btn-default  ui-btn-medium" href="{{ url("/Home/indent") }}" role="button">查看订单</a>
                            </div>
                        </div>
                    </div>
