...
<!--        <th align="center" valign="middle" class="borderright"><center>序号</center></th>-->
        ...
        <th align="center" valign="middle" class="borderright"><center>介绍</center></th>
    ...
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><img src="{{$good->img}}" width="50" height="50"><br/></td>
        <td align="center" valign="middle" class="borderright borderbottom">{{$good->price}}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{{$good->content}}</td>
        <td align="center" valign="middle" class="borderbottom">
<!--            <a href="/admin/user/add" target="_self" onFocus="this.blur()" class="add">添加</a><span class="gray">&nbsp;|&nbsp;</span>-->
            <a href="/admin/goods/update/{{$good->gid}}" target="main" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
            
            <a href="/admin/goods/delete/{{$good->gid}}" target="main" onFocus="this.blur()" class="add">删除</a>
        </td>
    </tr>
   @endforeach
    </table>
