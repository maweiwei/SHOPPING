<html>
    <head>
        ...
        <style>
            ...
            #main-tab{ border:1px solid #eaeaea; background:#FFF; font-size:12px; margin-top:20px;}
            ...
            .text-but{ width:100px; height:40px; line-height:30px; border: 1px solid #cdcdcd; background:#e6e6e6; font-family:"Microsoft YaHei","Tahoma","Arial",'宋体'; color:#666; float:left; margin:0 10px 0 0; display:inline; cursor:pointer; font-size:14px; font-weight:bold;}
        </style>
    </head>
    <body>
        <!--main_top-->
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                        <img src="{{$config->logo}}" width="266" height="78"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                    ...
                    <td align="left" valign="middle" class="borderright borderbottom main-for">
                        <a href="{{url('/admin/config/date')}}"><button type="button" class="text-but">修改</button></a>
                    </td>
                </tr>
            </table>
        </tr>
