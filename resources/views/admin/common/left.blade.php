            ...
            <tr>
                <td width="182" valign="top"><div id="container">
                        ...
                        <div class="content">
                            ...
                            <ul class="MM">
                                <li><a href="{{url('/admin/gg/new')}}" target="main">今日新品</a></li>
                                <li><a href="{{url('/admin/gg/vip')}}" target="main">会员推荐</a></li>
                                <li><a href="{{url('/admin/gg/old')}}" target="main">昨日上线</a></li>
                            </ul>
                        </div>
                    ...
                    <h1 class="type"><a href="javascript:void(0)">网站参数管理</a></h1>
                    <div class="content">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><img src="{{ asset("/images/admin/menu_topline.gif") }}" width="182" height="5" /></td>
                        ...
                        <ul class="MM">
                            <li><a href="{{url('/admin/config')}}" target="main">网站配置</a></li>
                        </ul>
                    </div>
                    </div>
